...
import com.ncs.abc.service.AppUserServiceImpl;
...
public class MyAppSecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		System.out.println(" --->> configure HTTp method - start");
		 ...
		 //	.and().
			...
			antMatchers("/fb/public/**").permitAll().
			antMatchers("/fb/admin/**").permitAll().
			antMatchers("/fb/user/**").permitAll().
	...
	public PasswordEncoder passwordEncoder()
	{
		...
		//return new BCryptPasswordEncoder(); // Spring internal
	}
